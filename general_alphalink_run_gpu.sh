...
GENE_NAME=$1
PROTEIN_ID=$2
FOLDER_NAME="${GENE_NAME}_${PROTEIN_ID}_true"  # Construct folder name dynamically
SUBFOLDER_NAME=$3
...
OUTPUT_POSTFIX="${SUBFOLDER_NAME}_1neff"
